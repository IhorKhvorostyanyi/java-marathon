    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && (update.getMessage().getText().equals("/start"))) {
            ...
            List<String> buttons = Arrays.asList("Сплести маскувальну сітку (+15 монет)",
                    "Зібрати кошти патріотичними піснями (+15 монет)n",
        ...
        if (update.hasCallbackQuery()) {
            ...
            if (update.getCallbackQuery().getData().equals("level_3_task") && (getLevel(chatId) == 3)) {
                ...
                List<String> buttons = Arrays.asList("Купити Джавелін (50 монет)");

                attachButtons(message, Map.of(buttons.get(0), "level_4_task"));
